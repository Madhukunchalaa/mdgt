            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-lg p-2 shadow-sm mb-3">
                    <div className="flex flex-col md:flex-row gap-2">
                        ...
                        <button
                            onClick={handleAddNew}
                            className="flex items-center px-3 w-1/8 py-1.5 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700"
                        >
...
>
  <div className="flex flex-col">
    <span className="font-medium capitalize text-xs">{request.type || "N/A"}</span>
    {request.type === 'material' && request.sap_item && (
      <span className="text-xs text-gray-500">Item ID: {request.sap_item}</span>
    )}
    {request.type === 'material group' && request.material_group && (
      <span className="text-xs text-gray-500">Group: {request.material_group}</span>
    )}
  </div>
</td>
<td
        ...
        <Trash2 size={14} />
            ...
            {isChatModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center p-3 border-b">
                            <h2 className="text-lg font-semibold text-gray-800">Update Chat Conversation</h2>
                            <button onClick={handleCloseModal} className="text-gray-400 hover:text-gray-600">
                                ✕
                            </button>
                        </div>
                        ...
                        <div className="p-4 grid grid-cols-1 gap-3">
                            ...
                            <div>
                                <label className="block text-xs font-medium text-gray-700 mb-1">User Text</label>
                                <textarea
                                    name="user_text"
            ...
            {isNotesModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center p-3 border-b">
                            <h2 className="text-lg font-semibold text-gray-800">Update Notes</h2>
                            <button onClick={handleCloseModal} className="text-gray-400 hover:text-gray-600">
                                ✕
                            </button>
                        </div>
            ...
            {isSapModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center p-3 border-b">
                            <h2 className="text-lg font-semibold text-gray-800">Assign SAP Item</h2>
                            <button onClick={handleCloseModal} className="text-gray-400 hover:text-gray-600">
                                ✕
                            </button>
                        </div>
                        ...
                        <div className="p-4 grid grid-cols-1 gap-3">
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-0.5">This will assign the SAP item to the request and close it</p>
                            </div>
                        </div>
